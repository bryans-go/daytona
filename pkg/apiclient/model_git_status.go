...
type GitStatus struct {
	...
	UnpushedCommits []CommitInfo `json:"unpushedCommits,omitempty"`
}
...
// SetUnpushedCommits gets a reference to the given []CommitInfo and assigns it to the UnpushedCommits field.
